<template>
  <v-container>
    <v-row justify="center">
      <v-btn color="amber lighten-2" @click.stop="adding = true">Add New Product</v-btn>
      <v-dialog v-model="adding" max-width="480">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer />
            <v-btn text color="amber darken-3" @click="clear">Cancel</v-btn>
            <v-btn text color="green darken-3" @click="add">Add</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-row>
